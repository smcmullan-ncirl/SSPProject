...
public class Values {
    ...
    public static String toHdr() {
        StringBuffer sb = new StringBuffer()
                .append("v_packets_sent").append("\t")
                .append("v_packet_loss").append("\t")
                .append("v_mean_rtt_ms").append("\t")
                .append("v_CalledByLocation").append("\t")
                .append("v_MeasurementLatitude").append("\t")
                .append("v_max_rtt_ms").append("\t")
                .append("v_target_ip").append("\t")
                .append("v_stddev_rtt_ms").append("\t")
                .append("v_min_rtt_ms").append("\t")
                .append("v_MeasurementLongitude").append("\t")
                .append("v_filtered_mean_rtt_ms").append("\t")
                .append("v_error").append("\t")
                .append("v_ping_method").append("\t")
                .append("v_battery").append("\t")
                .append("v_src_ip").append("\t")
                .append("v_dst_ip").append("\t")
                .append("v_measure").append("\t")
                .append("v_time").append("\t")
                .append("v_context_results").append("\t")
